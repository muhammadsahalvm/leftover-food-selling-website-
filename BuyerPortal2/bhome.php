...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="logop.PNG" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        ...
        <a class="float-left" href="bhome.php">
            <img src="logop.PNG" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
    ...
    <div class="container"> <img src="food.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 id="headings" class="guard"><span><b>Breakfast </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Fresh fruits</h2> -->
            <h1 id="headings" class="guard"><span><b>Lunch </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>Dinner</b></span>
            </h1>
        </div>
        <br>
        <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="">Food Hub</a></u> is a company</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Foodhub</a></p>
                </div>
                </hr>
            </div>
        </div>
