...
<body>
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;													"><b>Breakfast<br/></b></label></div>
	<table class="tabless">
		<tr>
			<th rowspan=2 colspan=2><a href="../BuyerPortal/BuyerProductDetails.php?id=31"><img class="images " src="../Admin/product_images/break1.jpg" width=600px height=400px></a></th>
			<td><a href="../BuyerPortal/BuyerProductDetails.php?id=17"><img class="small_images" src="../Admin/product_images/break2.jpg" height="200px" width="300px"></a></td>
			<td><a href="../BuyerPortal/BuyerProductDetails.php?id=24"><img class="small_images " src="../Admin/product_images/break3.jpg" height="200px" width="300px"></a></td>
		</tr>
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Lunch</b></label></div>
	<div id="vegs">
	...
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Dinner</b></label></div>
	<div id="crops">
